...
ActiveRecord::Schema.define(version: 20170327150918) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["therapy_id"], name: "index_comments_on_therapy_id", using: :btree
  ...
  add_foreign_key "comments", "therapies"
